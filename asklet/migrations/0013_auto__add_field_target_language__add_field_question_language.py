...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Target.language'
        db.add_column(u'asklet_target', 'language',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=2, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Question.language'
        db.add_column(u'asklet_question', 'language',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=2, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Target.language'
        db.delete_column(u'asklet_target', 'language')

        # Deleting field 'Question.language'
        db.delete_column(u'asklet_question', 'language')
