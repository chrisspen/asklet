...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TargetQuestionWeight.prob'
        db.add_column('asklet_targetquestionweight', 'prob',
                      self.gf('django.db.models.fields.FloatField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TargetQuestionWeight.prob'
        db.delete_column('asklet_targetquestionweight', 'prob')
