...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Target.slug_parts'
        db.add_column(u'asklet_target', 'slug_parts',
                      self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Question.slug_parts'
        db.add_column(u'asklet_question', 'slug_parts',
                      self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Target.slug_parts'
        db.delete_column(u'asklet_target', 'slug_parts')

        # Deleting field 'Question.slug_parts'
        db.delete_column(u'asklet_question', 'slug_parts')
