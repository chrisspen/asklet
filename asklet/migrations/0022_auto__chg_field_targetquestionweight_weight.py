...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TargetQuestionWeight.weight'
        db.alter_column(u'asklet_targetquestionweight', 'weight', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'TargetQuestionWeight.weight'
        db.alter_column(u'asklet_targetquestionweight', 'weight', self.gf('django.db.models.fields.IntegerField')())
