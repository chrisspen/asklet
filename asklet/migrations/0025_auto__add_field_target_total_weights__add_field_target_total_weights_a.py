...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field argument_weights on 'TargetQuestionWeightInference'
        m2m_table_name = db.shorten_name(u'asklet_targetquestionweightinference_argument_weights')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('targetquestionweightinference', models.ForeignKey(orm[u'asklet.targetquestionweightinference'], null=False)),
            ('targetquestionweight', models.ForeignKey(orm[u'asklet.targetquestionweight'], null=False))
        ))
        db.create_unique(m2m_table_name, ['targetquestionweightinference_id', 'targetquestionweight_id'])

        # Adding field 'Target.total_weights'
        db.add_column(u'asklet_target', 'total_weights',
                      self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Target.total_weights_aq'
        db.add_column(u'asklet_target', 'total_weights_aq',
                      self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Target.total_weights_uaq'
        db.add_column(u'asklet_target', 'total_weights_uaq',
                      self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'TargetQuestionWeight.text'
        db.add_column(u'asklet_targetquestionweight', 'text',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing M2M table for field argument_weights on 'TargetQuestionWeightInference'
        db.delete_table(db.shorten_name(u'asklet_targetquestionweightinference_argument_weights'))

        # Deleting field 'Target.total_weights'
        db.delete_column(u'asklet_target', 'total_weights')

        # Deleting field 'Target.total_weights_aq'
        db.delete_column(u'asklet_target', 'total_weights_aq')

        # Deleting field 'Target.total_weights_uaq'
        db.delete_column(u'asklet_target', 'total_weights_uaq')

        # Deleting field 'TargetQuestionWeight.text'
        db.delete_column(u'asklet_targetquestionweight', 'text')
