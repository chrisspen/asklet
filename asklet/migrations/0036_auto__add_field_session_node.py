...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Session.node'
        db.add_column(u'asklet_session', 'node',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='sessions', null=True, to=orm['asklet.RankingNode']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Session.node'
        db.delete_column(u'asklet_session', 'node_id')
