...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.total_weights'
        db.add_column(u'asklet_question', 'total_weights',
                      self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Question.total_weights_aq'
        db.add_column(u'asklet_question', 'total_weights_aq',
                      self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Question.total_weights_uaq'
        db.add_column(u'asklet_question', 'total_weights_uaq',
                      self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.total_weights'
        db.delete_column(u'asklet_question', 'total_weights')

        # Deleting field 'Question.total_weights_aq'
        db.delete_column(u'asklet_question', 'total_weights_aq')

        # Deleting field 'Question.total_weights_uaq'
        db.delete_column(u'asklet_question', 'total_weights_uaq')
