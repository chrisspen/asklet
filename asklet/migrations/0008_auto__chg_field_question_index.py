...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Question.index'
        db.alter_column(u'asklet_question', 'index', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Question.index'
        db.alter_column(u'asklet_question', 'index', self.gf('django.db.models.fields.PositiveIntegerField')())
