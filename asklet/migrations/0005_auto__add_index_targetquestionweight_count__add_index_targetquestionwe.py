...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'TargetQuestionWeight', fields ['count']
        db.create_index('asklet_targetquestionweight', ['count'])

        # Adding index on 'TargetQuestionWeight', fields ['weight']
        db.create_index('asklet_targetquestionweight', ['weight'])


    def backwards(self, orm):
        # Removing index on 'TargetQuestionWeight', fields ['weight']
        db.delete_index('asklet_targetquestionweight', ['weight'])

        # Removing index on 'TargetQuestionWeight', fields ['count']
        db.delete_index('asklet_targetquestionweight', ['count'])
