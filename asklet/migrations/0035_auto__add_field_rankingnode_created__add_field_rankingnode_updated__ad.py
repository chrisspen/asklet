...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RankingNode.created'
        db.add_column(u'asklet_rankingnode', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 10, 6, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'RankingNode.updated'
        db.add_column(u'asklet_rankingnode', 'updated',
        ...
        # Adding field 'RankingNode.fresh'
        db.add_column(u'asklet_rankingnode', 'fresh',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RankingNode.created'
        db.delete_column(u'asklet_rankingnode', 'created')

        # Deleting field 'RankingNode.updated'
        db.delete_column(u'asklet_rankingnode', 'updated')

        # Deleting field 'RankingNode.fresh'
        db.delete_column(u'asklet_rankingnode', 'fresh')
