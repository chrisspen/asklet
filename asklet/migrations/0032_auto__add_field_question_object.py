...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.object'
        db.add_column(u'asklet_question', 'object',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='questions', null=True, to=orm['asklet.Target']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.object'
        db.delete_column(u'asklet_question', 'object_id')
