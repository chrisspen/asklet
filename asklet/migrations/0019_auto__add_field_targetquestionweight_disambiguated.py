...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TargetQuestionWeight.disambiguated'
        db.add_column(u'asklet_targetquestionweight', 'disambiguated',
                      self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TargetQuestionWeight.disambiguated'
        db.delete_column(u'asklet_targetquestionweight', 'disambiguated')
