...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Target.pos'
        db.add_column(u'asklet_target', 'pos',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=1, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Target.sense'
        db.add_column(u'asklet_target', 'sense',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=500, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Target.slug'
        db.alter_column(u'asklet_target', 'slug', self.gf('django.db.models.fields.CharField')(max_length=500))
        # Adding field 'Question.pos'
        db.add_column(u'asklet_question', 'pos',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=1, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Question.sense'
        db.add_column(u'asklet_question', 'sense',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=500, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Question.slug'
        db.alter_column(u'asklet_question', 'slug', self.gf('django.db.models.fields.CharField')(max_length=500))

    def backwards(self, orm):
        # Deleting field 'Target.pos'
        db.delete_column(u'asklet_target', 'pos')

        # Deleting field 'Target.sense'
        db.delete_column(u'asklet_target', 'sense')


        # Changing field 'Target.slug'
        db.alter_column(u'asklet_target', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=500))
        # Deleting field 'Question.pos'
        db.delete_column(u'asklet_question', 'pos')

        # Deleting field 'Question.sense'
        db.delete_column(u'asklet_question', 'sense')


        # Changing field 'Question.slug'
        db.alter_column(u'asklet_question', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=500))
