...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'asklet_domain', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Target.created'
        db.add_column(u'asklet_target', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FileImport.created'
        db.add_column(u'asklet_fileimport', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Question.created'
        db.add_column(u'asklet_question', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'TargetQuestionWeight.created'
        db.add_column(u'asklet_targetquestionweight', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'InferenceRule.created'
        db.add_column(u'asklet_inferencerule', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'asklet_domain', 'created')

        # Deleting field 'Target.created'
        db.delete_column(u'asklet_target', 'created')

        # Deleting field 'FileImport.created'
        db.delete_column(u'asklet_fileimport', 'created')

        # Deleting field 'Question.created'
        db.delete_column(u'asklet_question', 'created')

        # Deleting field 'TargetQuestionWeight.created'
        db.delete_column(u'asklet_targetquestionweight', 'created')

        # Deleting field 'InferenceRule.created'
        db.delete_column(u'asklet_inferencerule', 'created')
