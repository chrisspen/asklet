...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'asklet_question', 'slug', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Question.slug'
        raise RuntimeError("Cannot reverse this migration. 'Question.slug' and its values cannot be restored.")
