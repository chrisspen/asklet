...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('asklet_domain', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=500))

        # Changing field 'Target.slug'
        db.alter_column('asklet_target', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=500))

        # Changing field 'Question.slug'
        db.alter_column('asklet_question', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'Domain.slug'
        db.alter_column('asklet_domain', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))

        # Changing field 'Target.slug'
        db.alter_column('asklet_target', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))

        # Changing field 'Question.slug'
        db.alter_column('asklet_question', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
