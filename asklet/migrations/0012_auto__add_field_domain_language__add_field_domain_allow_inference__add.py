...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Domain.language'
        db.add_column(u'asklet_domain', 'language',
                      self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Domain.allow_inference'
        db.add_column(u'asklet_domain', 'allow_inference',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Domain.max_inference_depth'
        db.add_column(u'asklet_domain', 'max_inference_depth',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=5),
                      keep_default=False)

        # Adding field 'Domain.min_inference_probability'
        db.add_column(u'asklet_domain', 'min_inference_probability',
                      self.gf('django.db.models.fields.FloatField')(default=0.1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Domain.language'
        db.delete_column(u'asklet_domain', 'language')

        # Deleting field 'Domain.allow_inference'
        db.delete_column(u'asklet_domain', 'allow_inference')

        # Deleting field 'Domain.max_inference_depth'
        db.delete_column(u'asklet_domain', 'max_inference_depth')

        # Deleting field 'Domain.min_inference_probability'
        db.delete_column(u'asklet_domain', 'min_inference_probability')
