...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FileImport.complete'
        db.add_column(u'asklet_fileimport', 'complete',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FileImport.complete'
        db.delete_column(u'asklet_fileimport', 'complete')
