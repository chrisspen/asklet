...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'asklet_ranking', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('session', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['asklet.Session'])),
            ('target', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['asklet.Target'])),
            ('ranking', self.gf('django.db.models.fields.FloatField')(db_index=True)),
        ))
        db.send_create_signal(u'asklet', ['Ranking'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'asklet_ranking')
    ...
    models = {
        ...
        u'asklet.ranking': {
            'Meta': {'unique_together': "(('session', 'target'),)", 'object_name': 'Ranking'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ranking': ('django.db.models.fields.FloatField', [], {'db_index': 'True'}),
            'session': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['asklet.Session']"}),
            'target': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['asklet.Target']"})
        },
        u'asklet.session': {
