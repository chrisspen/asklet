...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Target.index'
        db.alter_column(u'asklet_target', 'index', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Target.index'
        db.alter_column(u'asklet_target', 'index', self.gf('django.db.models.fields.PositiveIntegerField')())
