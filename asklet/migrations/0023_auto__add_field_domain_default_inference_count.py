...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Domain.default_inference_count'
        db.add_column(u'asklet_domain', 'default_inference_count',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Domain.default_inference_count'
        db.delete_column(u'asklet_domain', 'default_inference_count')
