...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Domain.assumption'
        db.add_column('asklet_domain', 'assumption',
                      self.gf('django.db.models.fields.CharField')(default='closed', max_length=25, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Domain.assumption'
        db.delete_column('asklet_domain', 'assumption')
