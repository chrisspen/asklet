...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RankingNode.domain'
        db.add_column(u'asklet_rankingnode', 'domain',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='ranking_nodes', to=orm['asklet.Domain']),
                      keep_default=False)

        # Adding unique constraint on 'RankingNode', fields ['domain', 'parent', 'question', 'answer']
        db.create_unique(u'asklet_rankingnode', ['domain_id', 'parent_id', 'question_id', 'answer'])


    def backwards(self, orm):
        # Removing unique constraint on 'RankingNode', fields ['domain', 'parent', 'question', 'answer']
        db.delete_unique(u'asklet_rankingnode', ['domain_id', 'parent_id', 'question_id', 'answer'])

        # Deleting field 'RankingNode.domain'
        db.delete_column(u'asklet_rankingnode', 'domain_id')
    ...
    models = {
        ...
        u'asklet.rankingnode': {
            'Meta': {'unique_together': "(('domain', 'parent', 'question', 'answer'),)", 'object_name': 'RankingNode'},
            'answer': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'domain': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ranking_nodes'", 'to': u"orm['asklet.Domain']"}),
        ...
        u'asklet.session': {
            ...
            'node': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'sessions'", 'null': 'True', 'to': u"orm['asklet.RankingNode']"}),
