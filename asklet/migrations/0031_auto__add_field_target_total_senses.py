...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Target.total_senses'
        db.add_column(u'asklet_target', 'total_senses',
                      self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Target.total_senses'
        db.delete_column(u'asklet_target', 'total_senses')
