...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TargetQuestionWeight.disambiguation_success'
        db.add_column(u'asklet_targetquestionweight', 'disambiguation_success',
                      self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TargetQuestionWeight.disambiguation_success'
        db.delete_column(u'asklet_targetquestionweight', 'disambiguation_success')
