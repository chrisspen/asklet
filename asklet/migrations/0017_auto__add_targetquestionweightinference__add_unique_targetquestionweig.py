...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TargetQuestionWeightInference'
        db.create_table(u'asklet_targetquestionweightinference', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('rule', self.gf('django.db.models.fields.related.ForeignKey')(related_name='inferences', to=orm['asklet.InferenceRule'])),
            ('weight', self.gf('django.db.models.fields.related.ForeignKey')(related_name='inferences', to=orm['asklet.TargetQuestionWeight'])),
            ('arguments', self.gf('django.db.models.fields.CharField')(max_length=500)),
        ))
        db.send_create_signal(u'asklet', ['TargetQuestionWeightInference'])

        # Adding unique constraint on 'TargetQuestionWeightInference', fields ['rule', 'weight', 'arguments']
        db.create_unique(u'asklet_targetquestionweightinference', ['rule_id', 'weight_id', 'arguments'])

        # Adding model 'InferenceRule'
        db.create_table(u'asklet_inferencerule', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('domain', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['asklet.Domain'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('lhs', self.gf('django.db.models.fields.TextField')()),
            ('rhs', self.gf('django.db.models.fields.TextField')()),
            ('enabled', self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True)),
        ))
        db.send_create_signal(u'asklet', ['InferenceRule'])

        # Adding unique constraint on 'InferenceRule', fields ['domain', 'name']
        db.create_unique(u'asklet_inferencerule', ['domain_id', 'name'])

        # Adding field 'TargetQuestionWeight.inference_depth'
        db.add_column(u'asklet_targetquestionweight', 'inference_depth',
                      self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'InferenceRule', fields ['domain', 'name']
        db.delete_unique(u'asklet_inferencerule', ['domain_id', 'name'])

        # Removing unique constraint on 'TargetQuestionWeightInference', fields ['rule', 'weight', 'arguments']
        db.delete_unique(u'asklet_targetquestionweightinference', ['rule_id', 'weight_id', 'arguments'])

        # Deleting model 'TargetQuestionWeightInference'
        db.delete_table(u'asklet_targetquestionweightinference')

        # Deleting model 'InferenceRule'
        db.delete_table(u'asklet_inferencerule')

        # Deleting field 'TargetQuestionWeight.inference_depth'
        db.delete_column(u'asklet_targetquestionweight', 'inference_depth')
    ...
    models = {
        ...
        u'asklet.domain': {
            ...
            'min_inference_probability': ('django.db.models.fields.FloatField', [], {'default': '0.1'}),
        ...
        u'asklet.inferencerule': {
            ...
            'domain': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['asklet.Domain']"}),
